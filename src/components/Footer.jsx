...
export default function Footer() {
  return (
    <footer className="bg-brand-walnut text-brand-cream">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-9 h-9 border border-brand-cream/20 flex items-center justify-center hover:bg-brand-champagne hover:text-brand-walnut hover:border-brand-champagne transition-all"
          ...
          {/* Shop */}
          <div>
            <h4 className="text-xs font-semibold tracking-widest uppercase mb-6 text-brand-champagne">Shop</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-xs font-semibold tracking-widest uppercase mb-6 text-brand-champagne">Company</h4>
            <ul className="space-y-3 text-sm text-brand-cream/60">
