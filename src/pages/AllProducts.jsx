      ...
      <div className="flex flex-col md:flex-row gap-4 mb-10">
        ...
        <div className="relative flex-1 max-w-sm">
          <input
            ...
            className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-sm focus:outline-none focus:border-luxury-green transition-colors"
          />
        ...
        <div className="flex gap-1 overflow-x-auto">
          <button
            ...
            className={`px-4 py-2 text-xs font-medium tracking-wider uppercase whitespace-nowrap transition-colors ${
              selectedCategory === "all" ? "bg-luxury-dark text-white" : "text-gray-500 hover:text-luxury-dark"
            }`}
          >
            All
          </button>
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-medium tracking-wider uppercase whitespace-nowrap transition-colors ${
                selectedCategory === cat.slug ? "bg-luxury-dark text-white" : "text-gray-500 hover:text-luxury-dark"
              }`}
            >
              {cat.name}
            </button>
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <button
            ...
            className="text-sm font-medium underline hover:text-luxury-green transition-colors"
          >
            Clear filters
          </button>
        </div>
