        ...
        <div className="flex gap-1 overflow-x-auto">
          <button
            ...
            className={`px-4 py-2 text-xs font-medium tracking-wider uppercase whitespace-nowrap transition-colors ${
              selectedCategory === "all" ? "bg-brand-dark text-white" : "text-gray-500 hover:text-brand-dark"
            }`}
          >
            All
          </button>
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-medium tracking-wider uppercase whitespace-nowrap transition-colors ${
                selectedCategory === cat.slug ? "bg-brand-dark text-white" : "text-gray-500 hover:text-brand-dark"
              }`}
            >
              {cat.name}
            </button>
