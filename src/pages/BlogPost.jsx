...
export default function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-32 text-center">
        ...
        <Link to="/blog" className="text-sm font-medium underline hover:text-brand-champagne transition-colors">Back to Journal</Link>
      </div>
    );
  }
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 lg:px-8 py-16">
      <Link to="/blog" className="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-brand-walnut mb-8 transition-colors">
